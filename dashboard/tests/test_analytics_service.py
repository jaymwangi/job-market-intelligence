...
class TestAnalyticsService:
    ...
    def test_refresh_all_clears_cache_alternative(self):
        """Test that refresh_all clears the cache (alternative assertion)."""
        mock_cache = Mock()
        self.service.cache_manager = mock_cache
        
        self.service.refresh_all()
        
        # Alternative verification using assertTrue and call_count
