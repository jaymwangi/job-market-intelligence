...
from ..schemas.analytics import (
    TopSkill, TopCompany, LocationAnalytics, SalaryStatistics,
    SalaryDistribution, EmploymentType, PostingTrend, DashboardSummary
)
from ..schemas.chart_data import (
    MetricCardData, BarChartData, HorizontalBarChartData,
...
class AnalyticsMapper:
    ...
    def to_metric_cards(self, summary: Optional[DashboardSummary]) -> List[MetricCardData]:
