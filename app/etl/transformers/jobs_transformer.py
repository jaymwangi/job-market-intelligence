...
class JobsTransformer:
    ...
    def _company(self, job: Dict[str, Any]) -> Optional[str]:
    ...
    def _location(self, job: Dict[str, Any]) -> Optional[str]:
    ...
    def _salary(self, job: Dict[str, Any], key: str) -> Optional[float]:
    ...
    def _currency(self, job: Dict[str, Any]) -> Optional[str]:
