...
class JobValidated(BaseModel):
    ...
    salary_min: Optional[float] = Field(default=None, ge=0, description="Minimum salary")
    salary_max: Optional[float] = Field(default=None, ge=0, description="Maximum salary")
    ...
    source_url: Optional[HttpUrl] = Field(None, description="Original job URL")
