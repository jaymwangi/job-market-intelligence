...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_jobs_posted_date_desc", "jobs", [sa.literal_column("posted_date DESC")], unique=False
    )
    op.create_index("idx_jobs_salary_range", "jobs", ["salary_min", "salary_max"], unique=False)
    op.create_index(
        "idx_jobs_scraped_date_desc", "jobs", [sa.literal_column("scraped_date DESC")], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status", sa.String(length=50), server_default=sa.text("'running'"), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_pipeline_runs_source_site"), "pipeline_runs", ["source_site"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "idx_skills_name_lower", "skills", [sa.literal_column("lower(name)")], unique=False
    )
