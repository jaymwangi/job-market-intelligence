...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_pipeline_runs_started_at_desc", "pipeline_runs", [sa.text("started_at DESC")]
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["job_id"], ["jobs.id"], name=op.f("job_skills_job_id_fkey"), ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["skill_id"], ["skills.id"], name=op.f("job_skills_skill_id_fkey"), ondelete="CASCADE"
        ),
